...
<script>
//先在cmd 输入“npm install --save swiper”，给webpake安装swiper图片轮播插件
import Swiper from 'swiper'  //引入swiper
import 'swiper/dist/css/swiper.min.css'    //引入swiper的css文件
import HeaderTop from '../../components/HeaderTop/HeaderTop.vue'  //引入HeaderTop.vue组件，变成标签
